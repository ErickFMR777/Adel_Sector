"""
app.py — Buscador de contratos SECOP y Estudio del Sector (Streamlit).

Consulta SECOP I y SECOP II **en vivo** al pulsar «Buscar», refina los
resultados en local y genera el Estudio del Sector con la estructura de
la Guía V3 de Colombia Compra Eficiente, exportable a Word y PDF.

La orquestación de las consultas está en ``consulta.py``; la generación
del documento, en ``estudio_sector.py``.
"""
